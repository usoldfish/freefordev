...
| [PayPal](https://www.paypal.com) | 全球通用的收款兜底方案,中国大陆可注册商家账户提现到国内银行。 | 无月费,跨境交易约 4.4% + 固定费 | ✅ 无需 | ✅ 可直连<br>🌏 大陆可注册,提现需结汇,费率偏高 | ⭐⭐⭐ |
...
| [remove.bg](https://www.remove.bg) | 一键 AI 抠图,做封面图、商品图快速出活。 | 网页版免费(预览分辨率);API 50 次免费/月(1 Credit 试用 + 免费预览) | ✅ 无需 | ✅ 可直连 | ⭐⭐⭐ |
...
| [Meilisearch Cloud](https://www.meilisearch.com) | 开源搜索引擎,中文分词支持好,自托管免费,云版有试用。 | 开源自托管完全免费;Cloud 14 天试用 | ✅ 无需 | ✅ 可直连 | ⭐⭐⭐⭐ |
...
| [Pipedream](https://pipedream.com) | 面向开发者的自动化,节点里直接写代码,免费层对开发者相当够用。 | 免费计划:每天 100 Credits(约 100 次工作流执行) | ✅ 无需 | ✅ 可直连 | ⭐⭐⭐⭐ |
...
*本 README 由 `scripts/build.py` 自动生成于 2026-07-13,请勿手改。*